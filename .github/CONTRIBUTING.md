...
> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/zoullx/go-unifi/blob/main/docs/readme.md).

Before you ask a question, it is best to search for existing [Discussions](https://github.com/zoullx/go-unifi/discussions) or [issues](https://github.com/zoullx/go-unifi/issues)
...
-   Open a [Discussion](https://github.com/zoullx/go-unifi/discussions/new/choose).
...
-   Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read
    the [documentation](https://github.com/zoullx/go-unifi/blob/main/docs/readme.md). If you are looking for support, you might want to check [this section](#i-have-a-question)).
-   To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in
    the [bug tracker](https://github.com/zoullx/go-unifi/issues?q=label%3Abug).
...
-   Open an [Issue](https://github.com/zoullx/go-unifi/issues/new?template=bug_report.md)
-   Explain the behavior you would expect and the actual behavior.
-   Please provide as much context as possible and describe the _reproduction steps_ that someone else can follow to recreate the issue on their own. This usually includes your code. For good bug
...
-   Read the [documentation](https://github.com/zoullx/go-unifi/blob/main/docs/readme.md) carefully and find out if the functionality is already covered, maybe by an individual configuration.
-   Perform a [search](https://github.com/zoullx/go-unifi/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/zoullx/go-unifi/issues).
...
1. Clone the repository
    ```bash
    git clone https://github.com/zoullx/go-unifi.git
    ```
