...
func customizeBaseType(resource *Resource) {
	...
	case resource.StructName == "WLAN":
		baseType.Fields["PassphraseAutogenerated"] = NewFieldInfo("PassphraseAutogenerated", "passphrase_autogenerated", "bool", "", "", true, false, "")
	...
	case resource.StructName == "Network":
		baseType.Fields["IPV6Enabled"] = NewFieldInfo("IPV6Enabled", "ipv6_enabled", "bool", "", "", true, false, "")
	}
}
